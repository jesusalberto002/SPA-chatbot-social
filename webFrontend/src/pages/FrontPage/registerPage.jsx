...
const StepDetails = ({
  ...
  <div className="space-y-6">
    ...
    >
      {demoAccessLoading ? "Signing in…" : "DEMO ACCESS"}
    </Button>

    <div className="relative">
      <div className="flex items-center">
        <div className="flex-grow h-px bg-gray-300" />
        <span className="px-3 text-xs uppercase text-gray-500">Or register with email</span>
        <div className="flex-grow h-px bg-gray-300" />
      </div>
    </div>
...
export default function MultiStepRegisterPage() {
  const navigate = useNavigate()
  const { login } = useAuth()
  const [demoAccessLoading, setDemoAccessLoading] = useState(false)
      ...
      case 1:
        return (
          <StepDetails 
            ...
            demoAccessLoading={demoAccessLoading}
          />
        )
      case 2:
        return (
